...
namespace RMGWebApi.Controllers
{
    ...
    public class OperatorDefectEfficiencyController : Controller
    {
        ...
        public JsonResult Post(KPIViewModel kpiViewModel)
        {
            ...
            List<ProductionViewModel> highEfficiencyLowDefectOperatorSummaryDataList = new List<ProductionViewModel>();
            ...
            return Json(new {
                highEfficiencyLowDefectOperatorSummaryDataList = highEfficiencyLowDefectOperatorSummaryDataList,
